...
if($gamemode==="plan"){
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if(strval($plans[0]->game_data->holes[$hole-1]->status) == "incomplete"){
                ...
                if(isset($plans[0]->game_data->holes[$hole-1]->complete_type)){
                    $plans[0]->game_data->holes[$hole-1]->complete_type = "";
                }
                ...
                try {
                    ...
                    try{
                        ...
                        if(count($data)>0){
                            ...
                            http_response_code(200);
                            echo json_encode(array("selected_hole_putts_shots" => $sum_hole, 'clubs_used' => $clubs_used, "quick_shots" => $quick_shots_hole, "quick_putts" => $quick_putts_hole));
                        }
                    }
                    catch(Exception $e){
                        echo $e->getMessage();
