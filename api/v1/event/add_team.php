...
if(!isset($_POST['token']) || !isset($_POST['event_id']) || !isset($_POST['team_name']) || empty($_POST['team_name']) || !isset($_POST['team_members']) || empty($_POST['team_members'])){
...
try{
    ...
    // Add the new team to the list of teams in the event
    array_push($event[0]->match_data->teams, $newTeam);
