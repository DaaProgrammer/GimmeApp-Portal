...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
  ...
  <script>
    ...
    <div class="bg-white text-zinc-900 dark:bg-zinc-800 dark:text-white match_mode">
        ...
        <div class="divide-y divide-zinc-300 dark:divide-zinc-700 match_dynamic_clubs">
    ...
    <!-- Content for event mode -->
        <div class="divide-y divide-zinc-300 dark:divide-zinc-700 event_dynamic_clubs">


            <div class="p-4 flex justify-between items-center border_bottom">
                <span class="titles">Driver</span>
                <div class="chevrons d-flex align-items-center">
                  <span class="description mr-2">7</span>
                  <span>&gt;</span>
                </div>
            </div>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        var gamemode = 'match'; // Default gamemode set to 'match'
        ...
        function fetchData(gamemode) {
          ...
          $.ajax({
            url: 'https://duendedisplay.co.za/gimme/api/v1/statistics/clubs_played.php',
            type: 'POST',
            ...
            success: function(response) {
              if (gamemode === 'match') {
                const matchContainer = document.querySelector('.match_dynamic_clubs');
                matchContainer.innerHTML = ''; // Clear the container before adding new content
                if (response.club_counts.length === 0) {
                  setTimeout(function() {
                  ...
                  response.club_counts.forEach(club => {
                    const clubElement = document.createElement('div');
                    clubElement.className = 'p-4 flex justify-between items-center border_bottom';
                    clubElement.innerHTML = `
                      <span class="titles">${club.club_name}</span>
                      <div class="chevrons d-flex align-items-center">
                        <span class="description mr-2">${club.counter}</span>
                      </div>
                    `;
                    matchContainer.appendChild(clubElement);
                ...
                const eventContainer = document.querySelector('.event_dynamic_clubs');
                ...
                if (response.club_counts.length === 0) {
                  ...
                  response.club_counts.forEach(club => {
                    ...
                    `;
                    eventContainer.appendChild(clubElement);
              ...
              // Additional code to handle the response can be added here
            },
        ...
        // Initially fetch data for default gamemode
        fetchData(gamemode);
        ...
        tabs.forEach(function(tab) {
          tab.addEventListener('click', function() {
            ...
            fetchData(gamemode); // Fetch data whenever a new tab is selected
          });
        });
      });
    </script>
