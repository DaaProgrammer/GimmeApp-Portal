  ...
  <script>
    ...
    <div class="bg-white text-zinc-900 dark:bg-zinc-800 dark:text-white match_mode">
        ...
        <div class="divide-y">
            ...
            <a href="statistics_courses_holes_list.php" style="text-decoration: none;color:#212529">
              <div class="p-4 flex justify-between items-center card m-4">
                <div class="flex justify-between w-full">
                  <div class="flex justify-between">
                    ...
                    <div>
                      <span class="titles">Benoni Lake Club</span><br/>
                      <span class="description">Johannesburg, South Africa</span>
                    </div>
                  </div>
              ...
              <div class="p-4 flex justify-between items-center card m-4">
                <div class="flex justify-between w-full">
                  <div class="flex justify-between">
                    <img src="https://duendedisplay.co.za/gimme/api/v1/assets/img/Group_7.png" alt="Benoni Lakeview" class="mr-4">
                    <div>
                      <span class="titles">Ebotse Golf & Country Estate</span><br/>
