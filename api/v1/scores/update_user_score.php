...
if(!isset($_POST['user_scores']) || empty($_POST['user_scores'])){
    http_response_code(400);
    echo json_encode(array("msg" => "Invalid request"));
    exit;
}
...
try{
    ...
    // $scoreObject[0]->score_details = $user_scores;

    $updateResult = $scores_db->update($scoreObject[0]->id,['score_details' => $user_scores]);
