        ...
        <?php
            ...
            if($game_type == "strokeplay" || $game_type == "Strokeplay"):
                foreach ($data as $player_data) {
                    ...
                    echo "<td class='score' style='background:#2bb13f; color:white'>" . $player_data->score . "</td>";
        ...
        <?php
            ...
            if($game_type == "strokeplay" || $game_type == "Strokeplay"):
                ...
                foreach ($data as $team => $team_data) {
                    ...
                    echo "<td>";
                    foreach ($team_data->team as $player) {
                        echo <<<EOD
                        <span>
                    ...
                    echo "<td class='score' style='background:#2bb13f; color:white'>" . $team_data->score . "</td>";
